...
import static kaitou.ppp.dao.cache.CacheManager.cachedShopNameAndId;
...
public class CachedShopDaoImpl implements CachedShopDao {
    ...
    public void updateShops(Object... shops) {
        ...
        for (Object shop1 : shops) {
            ...
            cachedShopNameAndId.put(shop.getName(), shop.getId());
        }
    }
    ...
    @Override
    public String getCachedIdByName(String shopName) {
        String shopId = cachedShopNameAndId.get(shopName);
        return StringUtils.isEmpty(shopId) ? "" : shopId;
    }
}
